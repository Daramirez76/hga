  ...
  if (form) {
    ...
    if (btnCrear) {
      btnCrear.addEventListener('click', function(e) {
        ...
        // Mostrar Mensajes
        if (todosValidos) {
          window.HgaAlerts.success('Los datos de la actividad son validos');
          // Aquí iría la lógica para guardar/procesar los datos
        } else {
          window.HgaAlerts.warning('Por favor completa todos los campos de la actividad', 'Formulario incompleto');
        }
