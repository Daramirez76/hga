...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-03-2026 a las 23:46:42
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_agregar_medicamento` (IN `p_nombre_medic` VARCHAR(10), IN `p_fecha_entrada` DATE, IN `p_fecha_vencimiento` DATE, IN `p_cod_usuario` INT, IN `p_cod_residente` INT, IN `p_cod_rol` INT, IN `p_descrip_novedad` VARCHAR(100), IN `p_fecha_novedad` DATE, IN `p_stock` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_agregar_usuario` (IN `p_tipo_doc` VARCHAR(16), IN `p_doc_id` INT, IN `p_nombre` VARCHAR(100), IN `p_apellido` VARCHAR(100), IN `p-edad` INT(3), IN `p_direccion` VARCHAR(150), IN `p_telefono` BIGINT, IN `p_email` VARCHAR(100), IN `p_usuario` VARCHAR(100), IN `p_contraseña` VARCHAR(32), IN `p_cod_rol` INT, IN `p_parentesco` VARCHAR(32))   BEGIN
...
INSERT INTO `actividades_ludicas` (`Cod_acti_ludi`, `Nombre`, `Fecha`, `Hora_ini`, `Hora_fin`, `cod_residente`, `cod_rol`, `Lugar`) VALUES
(1, 'Actividad física ', '2025-09-14', '10:00:00', '11:00:00', 5, 2, 'Hogar Geriátrico Años Dorados'),
(2, 'Pintura', '2025-09-10', '09:30:00', '10:20:00', 2, 2, 'Hogar Geriátrico Años Dorados'),
(3, 'Actividad de memoria', '2025-09-11', '15:00:00', '15:45:00', 4, 2, 'Hogar Geriátrico Años Dorados'),
(4, 'Danzas', '2025-09-19', '10:15:00', '11:00:00', 3, 2, 'Hogar Geriátrico Años Dorados'),
(5, 'Fisioterapia', '2025-09-22', '09:00:00', '10:30:00', 1, 2, 'Hogar Geriátrico Años Dorados');
...
INSERT INTO `medicamentos` (`Cod_medicamento`, `nombre_medic`, `fecha_entrada`, `fecha_vencimiento`, `cod_usuario`, `cod_residente`, `cod_rol`, `descrip_novedad`, `fecha_novedad`, `stock`) VALUES
...
INSERT INTO `notificaciones` (`cod_Notificaciones`, `cod_usuario`, `cod_Residente`, `Descrip_Novedad`) VALUES
(1, 123456, 1, 'El residente de Nombre Alejandro debe de tomarse las\r\nAspirinas todos los días a las 10'),
(2, 10012345, 2, 'El residente de nombre Sebastián tiene reunión el 2025-09-02'),
(3, 10067890, 4, 'El residente de Nombre Valentina tiene una visita cancelada'),
(4, 1022937343, 5, 'El residente de Nombre Andrés tiene una cita médica agendada '),
(5, 30098765, 3, 'El residente de nombre Sebastián tiene una visita Pendiente');
...
INSERT INTO `reuniones` (`cod_Reunion`, `Link_Videollamada`, `cod_usuario`, `cod_Residente`, `Fecha_Reunion`, `Disponibilidad_dispoditivos`, `Confirmacion_personal`) VALUES
(1, 'https://fakevideocall.com', 123456, 1, '2025-08-30', 'Limitados', 'pendiente'),
(2, 'https://fakevideocall2.com', 10012345, 1, '2025-08-31', 'Limitados', 'Pendiente'),
(3, 'https://fakevideocall3.com', 10067890, 3, '2025-09-02', 'Limitados', 'Pendiente'),
(4, 'https://fakevideocall4.com', 107524976, 4, '2025-09-16', 'Limitados', 'Pendiente'),
(5, 'https://fakevideocall5.com', 30098765, 5, '2025-08-13', 'Limitados', 'Aceptados');
...
INSERT INTO `usuario` (`tipo_doc`, `doc_id`, `nombre`, `apellido`, `edad`, `direccion`, `telefono`, `email`, `usuario`, `contraseña`, `cod_rol`, `parentesco`) VALUES
('cc', 123456, 'Laura', 'Gómez', 25, 'Calle 50', 3112221111, 'laura@gmail.com', 'lgomez', 'clave123', 2, ''),
('cc', 10012345, 'juan', 'perez', 30, 'calle 10 #15-20', 3004567890, 'juan.perez@gmail.com', 'jperez', 'passJuan1', 1, ''),
('cc', 10067890, 'carlos', 'rodriguez', 22, 'av siempre viva 742', 3026543210, 'carlos.rodr@gmail.com', 'crodriguez', 'car1os', 4, ''),
('ce', 30098765, 'ana', 'martinez', 35, 'calle 50 #10-12', 3112223344, 'ana.mtz@gmail.com', 'amartinez', 'mari1234', 2, ''),
('cc', 107524976, 'mariana', 'martinez', 28, 'av chile 142', 3134147533, 'marian125@gmail.com', 'mariani', 'martinez125', 4, ''),
('cc', 1022937343, 'sandra', 'jimenez', 27, 'cra 5 #78-15', 3113156888, 'sandra22@gmail.com', 'sandrita', 'sanmenez3', 4, '');
...
ALTER TABLE `actividades_ludicas`
  ...
  ADD KEY `actividades_ludicas_ibfk_2` (`cod_rol`);
...
ALTER TABLE `actividades_ludicas`
  ...
  ADD CONSTRAINT `actividades_ludicas_ibfk_2` FOREIGN KEY (`cod_rol`) REFERENCES `roles` (`cod_rol`) ON DELETE CASCADE ON UPDATE CASCADE;
